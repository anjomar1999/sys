...
<h1><strong>FINANCING APPLICATION TRACKING SYSTEM</strong></h1></nav>
  ...
  <div class="container">
    ...
    <?php
    $sql = "SELECT * FROM `fnahis` WHERE id = $id LIMIT 1";
    $result = mysqli_query($conn, $sql);
    ...
    ?>
      ...
      <form action="move_data1.php" method="post" style="width:50vw; min-width:300px;">
              <div class="row mb-3">
                <div class="col">
                ...
                <div class="col">
                      ...
                      <div class="row mb-3">
                        <div class="col" align="right">
                          ...
                          <input type="submit" class="btn btn-danger" value="RETURN DATA">
                        </div>    
                        </div>
