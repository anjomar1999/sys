        ...
        ?>
          <tr>
            ...
            <td class="text-center">
              <a href="view?id=<?php echo $row["id"] ?>" class="link-dark"><i class="fas fa-eye" style='font-size:20px;color:black'></i></a>  
              <i class="fa-solid fas fa-i-cursor"></i>
              <a href="editlast.php?id=<?php echo $row["id"] ?>" class="link-success"><i class="fa-solid fa-pen-to-square" style='font-size:20px;color:darkblue'></i></a>
              <h5><form action="move_data.php" method="post">
                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                    <input type="submit" class="btn btn-warning btn-sm" value="SAVE"></h5>
            </td>
          </tr>
        <?php
        }
