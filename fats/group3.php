...
if (!isset($_SESSION['username']) || $_SESSION['username'] !== 'group3') {
...
<div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-header">
                        <h4 align="center"><strong>GROUP 3 DASHBOARD</strong></h4>
                    </div>
                    <br>
                                <form action="" method="GET">
                                    <div class="col mb-2" align="right">
                                        <input class="invisible-search-box" name="refresh" readonly value="GROUP 3">

                                        <button type="submit" class="btn btn-primary">Load</button>   
                                        <a href="gp3" class="btn btn-success">History</a>   
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['refresh']))
                                    {
                                        ...
                                        $query = "SELECT * FROM input WHERE CONCAT(gp) LIKE '%$filtervalues%' ";
                                            ...
                                            foreach($query_run as $items)
                                            {
                                              ...
                                              <tr>
                                                ...
                                                <td class="text-center">
                                                  <a href="bank?id=<?= $items["id"]; ?>" class="link-primary"><i class="fa-solid fas fa-glasses"></i></a>
                                                </td>
                                              </tr>
                                            <?php
                                            }
