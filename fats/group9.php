...
if (!isset($_SESSION['username']) || $_SESSION['username'] !== 'group9') {
...
<div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-header">
                        <h4 align="center"><strong>GROUP 9 DASHBOARD</strong></h4>
                    </div>
                    <br>
                                <form action="" method="GET">
                                    <div class="col mb-2" align="right">
                                        <input class="invisible-search-box" name="refresh" readonly value="GROUP 9">

                                        <button type="submit" class="btn btn-primary">Load</button>
                                        <a href="gp9" class="btn btn-success">History</a>       
