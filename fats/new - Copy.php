...
<h3><strong>FINANCING APPLICATION TRACKING SYSTEM</strong></h3></nav>
<br />
      ...
      <div class="container d-flex justify-content-center">
         ...
         <br />
                          ...
                          <h5>
                           ...
                           <input type="text" class="form-control" strtoupper name="cname" placeholder="Last Name, First Name, MI">
                           </div>
                           </h5>
                           ...
                           <input type="text" class="form-control" name="mp" placeholder="Last Name, First Name, MI">
                           </div>
                          ...
                          <h5>
                           ...
                           <input type="text" class="form-control" name="dp" placeholder="Down Payment">
                           </div>
                           </h5>
            ...
            <div class="col" align="center">
               ...
               <a href="totadmin" class="btn btn-secondary">Cancel</a>
</div>
            </div>
         </form>
      </div>
