...
<head>
  ...
  <h2><strong>APPLICATION HISTORY</strong></h2>
  </div>    
  <br />     
  <div class="container">
  <div class="col mb-3">
        ...
        ?>
          <tr>
            ...
            <td class="text-center">
              <a href="banks?id=<?php echo $row["id"] ?>" class="link-dark"><i class="fas fa-eye" style='font-size:20px;color:skyblue'></i></a>  
            </td>
          </tr>
        <?php
        }
